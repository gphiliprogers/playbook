...
+ [Story Splitting Quick Start Guide](#story-splitting-quick-start-guide)
+ [Writing Well Articulated User Stories Quick Start Guide](#writing-well-articulated-user-stories-quick-start-guide)
...
1. Prepare the story to be split; Does the story have all of the INVEST attributes, with the exception of small? See [Story Attributes](#story-attributes) for a refresher.) Yes/No
    + If Yes, continue.
    + if No, first refine the story before attempting to split it. See the [Well Articulated User Stories Quick Start Guide](#writing-well-articulated-user-stories-quick-start-guide) 
...
#### References
The content in this quick start guide is based on patterns observed and compiled by Richard Lawrence on his [blog](http://www.richardlawrence.info/2009/10/28/patterns-for-splitting-user-stories/)
See also:
[Invest In Good User Stories](https://agileforall.com/new-to-agile-invest-in-good-user-stories/)
 
...
Note: For the purposes of this quick start guide, we only describe the "Test that... " format for Acceptance Criteria, which is among the simplext alternatives in terms of syntax. 
